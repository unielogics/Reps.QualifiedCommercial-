...
import MarketingCloseLink, { marketingDetailHref, safeMarketingReturn } from "@/components/MarketingCloseLink";
...
export default function ContactDetailPage() {
  ...
  return <div className="contactDetail">
    ...
    {confirmArchive && <ContactArchiveDialog contact={row} onClose={() => setConfirmArchive(false)} onArchived={() => router.replace(safeMarketingReturn(params.get("returnTo")))} />}
  </div>;
}
